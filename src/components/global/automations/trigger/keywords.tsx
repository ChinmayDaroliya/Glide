  ...
  return (
    <div className='bg-background-80 flex flex-col gap-y-3 p-3 rounded-xl'>
      ...
      <div className='flex flex-wrap justify-start gap-2 items-center'>
        ...
        {
          latestVariable && latestVariable.status === 'pending' && latestVariable.variables && (
            <div className='bg-background-90 flex items-center gap-x-2 capitalize text-text-secondary
            py-1 px-4 rounded-full'>
        ...
        <Input
          ...
          style={
            {width:(Math.max(keyword.length || 10, 2),50) + 'ch'} 
          }
          value={keyword}
